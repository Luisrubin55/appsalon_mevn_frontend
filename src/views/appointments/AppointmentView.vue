...
<template>
    ...
    <p class="text-white text-lg mt-5">A continuación verifica tu informacion y confirma tu cita</p>

    <h3 class="text-3xl font-extrabold text-white ">Serviciós</h3>
    <p v-if="appointments.noServicesSelected" class="text-white text-2xl text-center">No hay Servicios Seleccíonados</p>
